...
if($_GET['password_user'] ){
    $bln_OK = false;
    $tab_message['tab_messageErreur'][] = " mot de passe invalide.";
}else{
    if(trim($_GET['password_user']) == ''){
        $bln_OK = false;
        $tab_message['tab_messageErreur'][] = "Le mot de passe est vide.";
    }
}
if($_GET['confirm_password_user']){
    $bln_OK = false;
    $tab_message['tab_messageErreur'][] = "Le mot de passe n'est pas identique.";
}else{
    if(trim($_GET['confirm_password_user']) == ''){
        $bln_OK = false;
        $tab_message['tab_messageErreur'][] = "mot de passe vide.";
    }
}
